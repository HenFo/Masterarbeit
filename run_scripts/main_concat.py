...
) -> tuple[MmLlamaConcat, Callable[[MmLlamaConcat], MmLlamaConcat]]:
    if stage == 1:
...
def _load_model_for_stage_1(model: MmLlamaConcat):
...
def _load_model_for_stage_2(model: MmLlamaConcat):
...
def _set_stage_1_changes(train_dataloader, epoch: int, **_):
    pass
